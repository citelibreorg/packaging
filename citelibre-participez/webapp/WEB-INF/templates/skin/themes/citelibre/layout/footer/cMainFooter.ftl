                ...
                <div class="footer-col middle">
                    ...
                    <ul class="list-unstyled li-space-lg">
                      ...
                      <li>
                            ...
                            <a class="white p-small ms-2" href="jsp/site/Portal.jsp" >Home</a>
                        </li>
                        <li>
                            <i class="fas fa-bell fa-fw"></i> 
                            <a class="white p-small ms-2" href="jsp/site/Portal.jsp?page=forms&view=stepView&id_form=1&init=true" >Report a problem</a>
                        </li>
                        <li>
                    ...
                    <div class="footer-col last">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li>
                                ...
                                <a class="white p-small ms-2" href="https://ama.gov.gh/contactus.php" title="Contact"> Contact</a>
                            </li>
                        </ul>
                    </div> 
                </#if>
