...
<#local isBannerImage><#if dskey('themethemecitelibre.site_property.bannerForm.showBannerImg.checkbox') == '1'>true<#else>false</#if></#local>
<#local hasBannerTitle>0</#local>
<#local bannerCredits=dskey('themethemecitelibre.site_property.banner.credits')>
<#local bannerTitleColor=dskey('themethemecitelibre.site_property.banner.title.color')>
<#local bannerTitleBGColor=dskey('themethemecitelibre.site_property.banner.title.bgcolor')>
<#local bannerTitlePadding=dskey('themethemecitelibre.site_property.banner.title.padding')>
<#local bannerBGImagePosY=dskey('themethemecitelibre.site_property.banner.image.positiony')>
...
<#if hasBannerTitle?number=1 && title?trim !=''><h1<#if titleStyle!=''> style="${titleStyle}"</#if><#if titleClass!=''> class="${titleClass}"</#if>>${title}</h1><#else><h1 class="visually-hidden">${title}</h1></#if>
<#nested>
</div>
</#macro>