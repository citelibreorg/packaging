...
('themecitelibre.site_property.banner', 'images/banner_v.jpg'),
('themecitelibre.site_property.banner.credits', 'Crédit photo : Sophie Robichon / Ville de Paris'),
('themecitelibre.site_property.banner.image.positionx', ''),
('themecitelibre.site_property.banner.image.positiony', ''),
('themecitelibre.site_property.banner.shown.checkbox', '1'),
('themecitelibre.site_property.banner.showSiteImgEverywhere.checkbox', '1'),
('themecitelibre.site_property.banner.title.bgcolor', ''),
('themecitelibre.site_property.banner.title.color', '#475390'),
('themecitelibre.site_property.banner.title.padding', ''),
('themecitelibre.site_property.bannerBrowserWarning.checkbox', '1'),
('themecitelibre.site_property.bannerForm.showBannerImg.checkbox', '1'),
('themecitelibre.site_property.bannerForm.showFormImg.checkbox', '1'),
('themecitelibre.site_property.bannerForm.showFormTitle.checkbox', '1'),
('themecitelibre.site_property.bannerMessage.CloseButton.checkbox', '1'),
('themecitelibre.site_property.bannerMessage.Duration', '0'),
('themecitelibre.site_property.bannerMessage.htmlblock', ''),
('themecitelibre.site_property.bannerMessage.Position', 'top:1rem;right:1rem;'),
('themecitelibre.site_property.bannerMessage.Title', ''),
('themecitelibre.site_property.bannerMessage.Type', 'info'),
('themecitelibre.site_property.config.datepicker.textblock', ''),
('themecitelibre.site_property.config.editor.textblock', ''),
('themecitelibre.site_property.footer.about', 'CiteLibre is made for cities, by cities, upon open source principals. <br> <a class="btn btn-link ps-0" href="//:lutece.paris.fr" title="[Nouvelle fenêtre] LUTECE website" target="_blank><img src="images/poweredby.png" alt="Powered by LUTECE"></a> '),
...
('themecitelibre.site_property.layout.type.checkbox', '0'),
('themecitelibre.site_property.link.showTargetIcon.checkbox', '1'),
('themecitelibre.site_property.menu.fixedMenu.checkbox', '1'),
('themecitelibre.site_property.menu.gototop.checkbox', '1'),
('themecitelibre.site_property.menu.hasDefaultMenu.checkbox', '1'),
('themecitelibre.site_property.menu.longMenu.checkbox', '0'),
('themecitelibre.site_property.menu.sidebarMenu.checkbox', '1'),
('themecitelibre.site_property.menu.sidebarMenuCollapse.checkbox', '0'),
('themecitelibre.site_property.menu.siteMapMenu.checkbox', '1'),
('themecitelibre.site_property.menu.skipLinkMainId', 'main'),
('themecitelibre.site_property.menu.skipLinkMenu.checkbox', '0'),
('themecitelibre.site_property.robotIndex.checkbox', '0'),
('themecitelibre.site_property.Url.accessibilityLabel', 'Accessibilité : Partiellement conforme'),
('themecitelibre.site_property.Url.accessibilityURL', 'jsp/site/Portal.jsp?page=htmlpage&amp;htmlpage=1'),
('themecitelibre.site_property.Url.cguURL', 'jsp/site/PopupLegalInfo.jsp'),
('themecitelibre.site_property.Url.cguURLLabel', 'Condition générales d\'utilisation'),
('themecitelibre.site_property.Url.contactURL', 'jsp/site/Portal.jsp?page=contact'),
('themecitelibre.site_property.Url.contactURLLabel', 'Contact'),
('themecitelibre.site_property.Url.cookieURL', 'jsp/site/Portal.jsp?page=htmlpage&amp;htmlpage=1'),
('themecitelibre.site_property.Url.cookieURLLabel', 'Gestion  des cookies'),
('themecitelibre.site_property.Url.dataURL', 'jsp/site/PopupCredits.jsp'),
('themecitelibre.site_property.Url.dataURLLabel', 'Politique de gestion des données à caractère personnel'),
('themecitelibre.site_property.Url.legalURL', 'jsp/site/PopupLegalInfo.jsp'),
('themecitelibre.site_property.Url.legalURLLabel', 'Mentions légales'),
