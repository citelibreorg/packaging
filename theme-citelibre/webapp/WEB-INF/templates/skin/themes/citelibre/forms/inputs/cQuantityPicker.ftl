...
<@cBlock class='quantity-picker d-flex ${isInvalid} ${class!}'>
    ...
    <@cInputGroup class='w-auto'>
        ...
        <@cInput type='number' name=name id=cId value=minQty class='form-control-input quantity-input' params="data-min='${minQty}' data-max='${maxQty}'" disabled=disabled required=required />
