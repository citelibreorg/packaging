...
<#macro cInfoStepOld steps haspicto=false hasidx=false title=false showMore=0 labelMore=i18n("themecitelibre.labelShowMore") a11StatusMsg='' class='' imgClass='' id='' params='' deprecated...>
