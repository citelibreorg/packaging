...
Parameters:
@param - scrollLabel - string - optional -  Nom du menu par défaut - #i18n{themecitelibre.gohome} / Haut de page - 
...
-->
<#macro cGoToTop scrollLabel='#i18n{themecitelibre.gohome}' scrollClass='primary fadein' scrollBtnClass='btn-gototop' scrollTop=100 deprecated...>
<@deprecatedWarning args=deprecated />
<@cBtn type='button' class='${scrollClass!} ${scrollBtnClass!}' label=scrollLabel nestedPos='after'><@cInline class='main-info-color'>&#8593;</@cInline></@cBtn>
<script>
