...
@param - btnShowLabel - string - optional - (NEW) gérer le texte du parametre "data-show-label" de l'accordion (par défaut: '#i18n{themecitelibre.labelShowDetail}')
@param - btnHideLabel - string - optional - (NEW) gérer le texte du parametre "data-hide-label" de l'accordion (par défaut: '#i18n{themecitelibre.labelHideDetail}')
...
-->
<#macro cAccordion id title btnTitle='' class='' titleClass='' titleLevel=3 subTitle='' subTitleClass='' btnClass='' btnShowLabel='#i18n{themecitelibre.labelShowDetail}' btnHideLabel='#i18n{themecitelibre.labelHideDetail}' header='' border=false state=true hasCollapse=true params='' deprecated...>
    ...
    <div class="card ${class!}<#if border> with-border</#if><#if subTitle !=''> with-subtitle</#if>" ${params!}>
        ...
        <@cTitle level=titleLevel class=cardTitleClass params=titleParams>
            ...
            <#if class?contains('outline')>
                ...
                <@citelibreIcon name='alert-${iconType}' />
                </span>
            ...
            <span class="accordion-toggle ms-auto">
                ...
                <span class="btn-accordion<#if btnClass !=''> ${btnClass}</#if>">
                    ...
                    <@citelibreIcon name='arrow-bottom' class=btnClass title='' />
                </span>
            </span>
            </#if>
            </button>
