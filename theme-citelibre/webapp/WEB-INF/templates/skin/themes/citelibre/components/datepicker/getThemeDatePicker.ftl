...
<#local dtThemeOptions>${dskey('themecitelibre.site_property.config.datepicker.textblock')!}</#local>
<script>
...
<#if !range>
  ...
  let datepicker${idField} = new themecitelibreDatepicker( elem${idField}, dtOptions${idField} );
<#else>
