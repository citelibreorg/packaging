...
-->
<#macro cMultiselect class='' labelOptionSelection='#i18n{themecitelibre.labelOptionSelection}' maxSelectedOptions=0 id='' helpMsg='' errorMsg='' params='' disabled=false deprecated...>
