...
Parameters:
@param - home - string - required - Titre de la page Home. Par défaut clé Fil d'ariane disponible dans le fichier "themecitelibre_messages_fr.properties"
...
-->
<#macro cBreadCrumb home='#i18n{themecitelibre.home}' items='' class='' type='' params='' deprecated...>
<@deprecatedWarning args=deprecated />
<nav aria-label="#i18n{themecitelibre.breadcrumb}" class="breadcrumb-nav<#if class!=''> ${class!}</#if>"<#if params!=''> ${params!}</#if>>
	<div class="container<#if type='fluid'>-fluid</#if>">
		<ol class="breadcrumb">
            <#if home!=''>
                <li class="breadcrumb-item">
                    <a target="_top" href="."><span class="fa fa-home me-2"></span> ${home!}</a>
                </li>
            </#if>
