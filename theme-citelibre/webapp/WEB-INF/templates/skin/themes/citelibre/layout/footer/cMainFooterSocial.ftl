...
<#if !dskey('themecitelibre.site_property.menu.sidebarMenu.checkbox')?starts_with('DS') && dskey('themecitelibre.site_property.menu.sidebarMenu.checkbox')?number == 1></div></div></#if>
    ...
    <div class="row m-0">
            ...
            <div class="main-footer justify-content-${align} py-4">
                <div class="d-flex align-items-center justify-content-center justify-content-lg-start w-100">
                    <a class="logo hide-icon-target" href="${urlMainSite}" target="_blank">
                        <@cImg src=logoFooter! class='d-inline-block' id='footer-img' alt='#i18n{themecitelibre.labelGoToSite} ${mainSite!}' />
                    </a>
                    <hr aria-hidden="true">
                    <a class="site" title="#i18n{themecitelibre.labelGoToSite} ${title}" href=".">${title}</a>
                </div>
            </div>  
            <div class="main-footer justify-content-${align}">
                <div class="d-flex align-items-center">
                    <ul class="nav d-flex justify-content-center justify-content-md-start" aria-label="#i18n{themecitelibre.footerInfo}" >
        ...
        <div class="col-12 main-bg-color<#if classColSocial !=''> ${classColSocial}</#if> d-flex justify-align-items">
            <div class="social-links">
                ...
                <h2 class="paris-footer-social-title text-center text-gray">#i18n{themecitelibre.labelFollow}</h2>
                ...
                <p class="paris-footer-social-title text-center">#i18n{themecitelibre.footerSocialText}</p>
            </div>
        </div>
    </div>
</footer>
