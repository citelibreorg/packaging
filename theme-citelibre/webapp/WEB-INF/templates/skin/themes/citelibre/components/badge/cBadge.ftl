...
-->
<#macro cBadge label='' class='' hasp=false dismissible=false id='' params='' deprecated...>
<@deprecatedWarning args=deprecated />
<span class="badge<#if class !=''> ${class}</#if><#if dismissible> dismissible</#if>"<#if id!=''> id="${id}"</#if><#if params !=''> ${params}</#if>>
<#if dismissible> 
