...
@param - size - string - optional - permet d'ajouter un suffixe à la classe CSS 'form-control-input', valeur possible 'lg' ou 'sm'
...
@param - step - number - optional - permet de saisir une valeur de step les champs de type number ou time (par défaut: 0)
